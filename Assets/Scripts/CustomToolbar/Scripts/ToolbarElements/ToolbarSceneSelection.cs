...
internal class ToolbarSceneSelection : BaseToolbarElement {
	...
	// [SerializeField] bool showSceneFolder = false;
	...
	private void DrawSceneDropdown() {
		selectedSceneIndex = EditorGUILayout.Popup(selectedSceneIndex, scenesPopupDisplay.Select(e => e.popupDisplay).ToArray(), new GUIStyle("Popup")
		{
